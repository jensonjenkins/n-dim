...
public:
    ...
    constexpr typename B::reference* operator->() noexcept { return &ref_; }
    ...
    constexpr iterator_intermediate_impl(typename B::base_element* data, 
            const typename B::element_dim_type& dim, 
            typename B::size_type index) noexcept : ref_(data, dim.inner()), index_(index) {}
    ...
    constexpr iterator_intermediate_impl& operator++() noexcept { ref_.shift(1); ++index_; return *this; }
    ...
    constexpr iterator_intermediate_impl& operator+=(typename B::difference_type n) noexcept { 
        ref_.shift(n); index_ += n; return *this; 
    }
    ...
    friend constexpr typename B::difference_type operator-(const iterator_intermediate_impl& b, 
            const iterator_intermediate_impl& a) noexcept { return b.index_ - a.index_; }
    constexpr bool operator==(const iterator_intermediate_impl& other) const { return index_ == other.index_; }
    constexpr bool operator!=(const iterator_intermediate_impl& other) const { return index_ != other.index_; }
    constexpr bool operator<(const iterator_intermediate_impl& other) { return ref_ < other.ref_; }
    constexpr bool operator>(const iterator_intermediate_impl& other) { return ref_ > other.ref_; }
    constexpr bool operator<=(const iterator_intermediate_impl& other) { return ref_ <= other.ref_; }
    constexpr bool operator>=(const iterator_intermediate_impl& other) { return ref_ >= other.ref_; }
...
public: 
    ...
    constexpr iterator_lowest_impl(typename B::base_element* data, 
            const typename B::element_dim_type&,
            typename B::size_type) noexcept : ptr_(data) {}
    ...
    friend constexpr typename B::difference_type operator-(const iterator_lowest_impl& b, 
            const iterator_lowest_impl& a) noexcept { return b.ptr_ - a.ptr_; }
    constexpr bool operator==(const iterator_lowest_impl& other) const { return ptr_ == other.ptr_; }
    constexpr bool operator!=(const iterator_lowest_impl& other) const { return ptr_ != other.ptr_; }
    constexpr bool operator<(const iterator_lowest_impl& other) noexcept { return ptr_ < other.ptr_; }
    constexpr bool operator>(const iterator_lowest_impl& other) noexcept { return ptr_ > other.ptr_; }
    constexpr bool operator<=(const iterator_lowest_impl& other) noexcept { return ptr_ <= other.ptr_; }
    constexpr bool operator>=(const iterator_lowest_impl& other) noexcept { return ptr_ >= other.ptr_; }
